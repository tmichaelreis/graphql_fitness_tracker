defmodule GraphqlFitnessTracker.Application do
  use Application
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: GraphqlFitnessTracker.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    GraphqlFitnessTrackerWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
